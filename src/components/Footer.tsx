...
export const Footer = () => {
  return (
    <footer className="bg-secondary/40 dark:bg-secondary/10 py-12 px-4 md:px-8">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-xl font-bold">EmailCheck</h3>
            </div>
            <p className="text-sm text-muted-foreground">
              Verify email addresses in seconds and improve your email deliverability rates with our powerful verification service.
            </p>
          ...
          <div>
            ...
            <div className="flex space-x-2">
              <Input placeholder="Your email" type="email" className="max-w-52" />
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">
              © 2025 EmailCheck. All rights reserved.
            </p>
